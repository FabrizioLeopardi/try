...
(cl:in-package my_rosplan_interface-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Marker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Marker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_rosplan_interface-msg:<Marker> is deprecated: use my_rosplan_interface-msg:Marker instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_rosplan_interface-msg:id-val is deprecated.  Use my_rosplan_interface-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'corners-val :lambda-list '(m))
(cl:defmethod corners-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_rosplan_interface-msg:corners-val is deprecated.  Use my_rosplan_interface-msg:corners instead.")
  (corners m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Marker>)))
  ...
  (cl:format cl:nil "int64 id~%geometry_msgs/Point[] corners~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Marker)))
  "Returns full string definition for message of type 'Marker"
  (cl:format cl:nil "int64 id~%geometry_msgs/Point[] corners~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
