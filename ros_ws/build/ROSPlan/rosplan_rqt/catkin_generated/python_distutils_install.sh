...
echo_and_run cd "/root/Desktop/ros_ws/src/ROSPlan/rosplan_rqt"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/Desktop/ros_ws/src/ROSPlan/rosplan_rqt/setup.py" \
     \
    build --build-base "/root/Desktop/ros_ws/build/ROSPlan/rosplan_rqt" \
    install \
    --root="${DESTDIR-/}" \
