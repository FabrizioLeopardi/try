...
echo_and_run cd "/root/Desktop/ros_ws/src/ROSPlan/rosplan_action_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/Desktop/ros_ws/src/ROSPlan/rosplan_action_interface/setup.py" \
     \
    build --build-base "/root/Desktop/ros_ws/build/ROSPlan/rosplan_action_interface" \
    install \
    --root="${DESTDIR-/}" \
